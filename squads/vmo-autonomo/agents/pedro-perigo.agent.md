...
- **Reads from**: `squads/vmo-autonomo/output/documentacao-base.md`; `squads/vmo-autonomo/output/cronograma.md`; `squads/vmo-autonomo/pipeline/data/anti-patterns.md`
- **Writes to**: `squads/vmo-autonomo/output/plano-riscos.md`
